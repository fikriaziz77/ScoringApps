...
namespace WindowsFormsApplication1
{
    class MySql
    {
        ...
        //Initialize values
        public void Initialize(string server1)
        {
            server = server1;
        ...
        public void UpdateScore(int courtnumber,string sc1,string sc2,string st1, string st2, string bal, string stat)
        {
            string query = "UPDATE court_list SET tim1scr='" + sc1 + "', tim2scr='" + sc2 + "', tim1set='" + st1 + "', tim2set='" + st2 + "',ball='" + bal + "',status='" + stat + "' WHERE court = " + courtnumber;
        ...
        {
            string query = "UPDATE court_list SET round='', tim1p1='', tim1p2='', tim1ins='', tim2p1='', tim2p2='', tim2ins='', tim1scr='', tim2scr='', tim1set='', tim2set='',ball='',status='' WHERE court = " + courtnumber; 
